    ...
    public static void main(String[] args) {
        /*
            [ Java 란? ]
                ...
                각 회사들은 대부분 윈도우, MAC, 리눅스 같이 다양한 OS 에서 작동하는 버전의 자바도 함께 제공한다.
                - 오라클 Open JDK
                - Adoptium Eclipse Temurin
                - Amazon Corretto

                자바 구현들은 모두 표준 스펙에 맞도록 개발되어 있다.
                따라서 오라클 Open JDK를 사용하다가 Amazon Corretto 자라로 변경해도 대부분 문제 없이 동작한다.
            ...
            [ 컴파일과 실행 ]
                ...
                2. 자바 컴파일러를 사용해서 소스 코드를 컴파일 한다.
                    2-1. 자바가 제공하는 javac 라는 프로그램을 사용한다.
                    2-2. .java => .class 파일이 생성된다.
                    2-3. 자바 소스 코드를 바이트코드로 변환하며 자바 가상 머신에서 더 빠르게 실행될 수 있게 최적화하고 문법 오류도 검출한다.
                3. 자바 프로그램을 실행한다.
                    3-1. 자바가 제공하는 java 라는 프로그램을 사용한다.
                    3-2. 자바 가상 머신(JVM)이 실행되면서 프로그램이 작동한다.
            ...
            [ IDE 와 자바 ]
                ...
                out 폴더에 들어가면, 바이트 코드로 컴파일된 .class 라는 파일이 생성 된 것을 확인 할 수 있다.
            ...
            [ 자바와 운영체제 독립성 ]
                ...
                예를 들어서 윈도우 프로그램은 MAC 이나 리눅스에서 작동하지 않는다.
                왜냐하면 윈오두 프로그램은 윈도우 OS가 사용하는 명령어들로 구성되어 있기 때문이다. 해당 명령어는 다른 OS 와는 호환되지 않는다.

                자바 프로그램
                자바 프로그램은 자바가 설치된 모든 OS 에서 실행할 수 있다.
                자바 개발자는 특정 OS에 맞추어 개발하지 않아도 된다. 자바 개발자는 자바에 맞추어 개발하면 된다. OS 호환성 문제는 자바가 해결하낟.
                ...
                서버는 주로 리눅스를 사용한다. 만약 AWS 를 사용한다면 Amazon Corretto 자바를 AWS 리눅스 서버에 설치하면 된다.
